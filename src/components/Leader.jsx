        ...
        <div className="container">
          <div className="row">
            ...
            <p>
              ...
              healthier, and more pleasant place to live or work. We are
              committed to providing advanced quality Health & Hygiene products
              & making them conveniently available across the country.
            </p>
            <p>
            ...
            <p>
              ...
              clients during testing times, we look forward to continuing to
              serve you with the highest standards of quality and excellence. We
              believe that by doing so, we can make a positive impact on the
              environment and the communities we serve. We strive to be a
              responsible and socially conscious company, inspiring others to
              join us in our mission to promote public health and well-being. We
              look forward to continuing to serve you with the highest standards
              of quality and excellence.
            </p>
            <p>
              Emperia 1900 is steadfastly committed to innovation and
              ...
              the experience gleaned from these lessons, Emperia 1900 will
              emerge as an icon of hygiene care across the country and the world
              will watch its unique success story. The opportunity to create a
            ...
            <p>
              We are proud to be a part of the effort to promote public health
              and prevent the spread of infections. We believe that our products
              and services will make a meaningful difference in the lives of
            ...
            <p>
              <em><b>
                "Our pursuit, to promote healthy living and prevent the spread
                of infections is guided by values far greater than us. We
                believe in providing effective and innovative hygiene care
                solutions that enable individuals and communities to maintain a
                clean and hygienic environment, whilst also having a
                customer-centric approach and serving as a responsible &
                socially conscious company that makes a positive impact on the
                nation.""
                </b></em>
            </p>
            <div className="col-2">
              <img src="img/ceo.png" alt="" className="img-fluid w-75" />
            </div>
            <div className="col">
              <h5>Mr. Sandeep Jain</h5>
              <p >Director and CEO of Empire Industries Limited - Emperia1900</p>
            </div>
          </div>
        </div>
      </section>
